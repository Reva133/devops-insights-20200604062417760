        ...
        <div className="col-sm-4">
            <div className="row">
                <div className="col-sm-10">
                    ...
                    <div id = "options">
                    	<input type = "radio" id ="us" name = "usa" onclick ="(function(){document.getElementById('nz').checked = false;})()"></input>
                    	<label for="us">US Zip Codes</label>
                    	<input type = "radio" id ="nz" name = "new" onclick ="(function(){document.getElementById('us').checked = false;})()"></input>
